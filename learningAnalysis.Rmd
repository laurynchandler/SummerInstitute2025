...
df_inf %>% 
  ...
  facet_grid(~congCue) + 
  theme_bw() + geom_point(aes(shape=accuracyFactor)) + stat_smooth(aes(linetype=accuracyFactor), method = 'lm') + labs(y = 'RTs during inference (decision making)', x = 'z confidence rating')
...
df_inf %>% 
  ...
  facet_grid(~congCue) + 
  theme_bw() + geom_point(aes(shape=accuracyFactor)) + stat_smooth(aes(linetype=accuracyFactor), method = 'lm') + labs(y = 'RTs during inference (decision making)', x = 'confidence rating RTs')
